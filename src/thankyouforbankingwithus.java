 ...
 * @author pragy
 */
public class thankyouforbankingwithus extends javax.swing.JFrame {

    /**
     * Creates new form atmGUI
     */

    public thankyouforbankingwithus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label_1.setFont(new java.awt.Font("Segoe UI", 1, 9)); // NOI18N
        label_1.setForeground(new java.awt.Color(255, 255, 51));
        label_1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label_1.setText("THANK YOU FOR BANKING WITH US");
        jPanel3.add(label_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 180, 20));
        ...
        label_4.setText("Press enter to return to main screen");
        jPanel3.add(label_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 180, -1));
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if(atm.a1.acno == ad.acno){
            atm.a1 = ad;
        }
        else if(atm.a2.acno == ad.acno){
            atm.a2 = ad;
        }
        else if(atm.a3.acno == ad.acno){
            atm.a3 = ad;
        }
        else if(atm.a3.acno == ad.acno){
            atm.a3 = ad;
        }
        else if(atm.a4.acno == ad.acno){
            atm.a4 = ad;
        }
        else if(atm.a5.acno == ad.acno){
            atm.a5 = ad;
        }
